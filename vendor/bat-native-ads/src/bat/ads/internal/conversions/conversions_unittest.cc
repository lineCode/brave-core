...
// #include "bat/ads/internal/conversions/ad_conversions.h"
...
//       const ConversionList& ad_conversions) {
...
//   SaveConversions(ad_conversions);
...
//       GetConversionHistoryForCreativeSet(info.creative_set_id);
...
//   // Assert
//   const std::deque<uint64_t> creative_set_history =
//       GetConversionHistoryForCreativeSet(creative_set_id);
...
//   TriggerAdEvent(info.creative_set_id, ConfirmationType::kTransferred);
...
// TEST_F(BatAdsConversionsTest,
//     ConvertAdWhenTheConversionObservationWindowHasNotExpired) {
//   // Arrange
//   ConversionList ad_conversions;
...
// TEST_F(BatAdsConversionsTest,
//     DoNotConvertAdWhenTheConversionObservationWindowIsOnTheCuspOfExpiring) {
//   // Arrange
//   ConversionList ad_conversions;
...
// TEST_F(BatAdsConversionsTest,
//     DoNotConvertAdWhenTheConversionObservationWindowHasExpired) {
//   // Arrange
//   ConversionList ad_conversions;
